...
public final class ProductServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.cartProto.Product.ProductListRequest,
      com.example.cartProto.Product.GetProducts> getGetProductByIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getProductById",
      requestType = com.example.cartProto.Product.ProductListRequest.class,
      responseType = com.example.cartProto.Product.GetProducts.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.cartProto.Product.ProductListRequest,
      com.example.cartProto.Product.GetProducts> getGetProductByIdMethod() {
    io.grpc.MethodDescriptor<com.example.cartProto.Product.ProductListRequest, com.example.cartProto.Product.GetProducts> getGetProductByIdMethod;
      ...
      synchronized (ProductServiceGrpc.class) {
        if ((getGetProductByIdMethod = ProductServiceGrpc.getGetProductByIdMethod) == null) {
          ProductServiceGrpc.getGetProductByIdMethod = getGetProductByIdMethod =
              io.grpc.MethodDescriptor.<com.example.cartProto.Product.ProductListRequest, com.example.cartProto.Product.GetProducts>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getProductById"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.cartProto.Product.ProductListRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.cartProto.Product.GetProducts.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getProductById(com.example.cartProto.Product.ProductListRequest request,
        io.grpc.stub.StreamObserver<com.example.cartProto.Product.GetProducts> responseObserver) {
  ...
  public static final class ProductServiceStub
    ...
    /**
     */
    public void getProductById(com.example.cartProto.Product.ProductListRequest request,
        io.grpc.stub.StreamObserver<com.example.cartProto.Product.GetProducts> responseObserver) {
  ...
  public static final class ProductServiceBlockingStub
    ...
    /**
     */
    public com.example.cartProto.Product.GetProducts getProductById(com.example.cartProto.Product.ProductListRequest request) {
  ...
  public static final class ProductServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.cartProto.Product.GetProducts> getProductById(
        com.example.cartProto.Product.ProductListRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PRODUCT_BY_ID:
          serviceImpl.getProductById((com.example.cartProto.Product.ProductListRequest) request,
              (io.grpc.stub.StreamObserver<com.example.cartProto.Product.GetProducts>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.cartProto.Product.ProductListRequest,
              com.example.cartProto.Product.GetProducts>(
  ...
  private static abstract class ProductServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.cartProto.Product.getDescriptor();
    }
